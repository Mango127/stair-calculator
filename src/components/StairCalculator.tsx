...
export default function StairCalculator() {
  ...
  const [activeSection, setActiveSection] = useState<"summary" | "calculator">("summary");
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {activeSection === "summary" ? (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-semibold tracking-tight text-foreground">Valid Configurations</h2>
              <p className="text-sm text-muted-foreground mt-1">
                All stair designs that comply with rise ≤190mm, tread ≥280mm, angle 30°–41°, Blondel 600–660mm
              </p>
            </div>
